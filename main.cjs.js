        ...
        if (validMutation) {
          ...
          if (receivingContext_1 === initialContext_1) {
            ...
            initialContext_1.emitter.trigger(
              "eventDrop",
              tslib.__assign(
                tslib.__assign(tslib.__assign({}, eventChangeArg), transformed),
                {
                  el: ev.subjectEl,
            ...
            initialContext_1.emitter.trigger(
              "eventLeave",
              tslib.__assign(tslib.__assign({}, eventRemoveArg), {
            ...
            receivingContext_1.emitter.trigger(
              "eventReceive",
              tslib.__assign(tslib.__assign({}, eventAddArg), {
                draggedEl: ev.subjectEl,
                view: finalHit.component.context.viewApi,
              })
            );
    ...
    _this.handleDragEnd = function (ev) {
      ...
      if (_this.validMutation) {
        ...
        context.emitter.trigger(
          "eventResize",
          tslib.__assign(tslib.__assign({}, eventChangeArg), {
            el: _this.draggingSegEl,
            startDelta:
